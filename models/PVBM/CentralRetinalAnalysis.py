...
from models.PVBM.helpers.tortuosity import compute_tortuosity
from models.PVBM.helpers.perimeter import compute_perimeter_
from models.PVBM.helpers.branching_angle import compute_angles_dictionary
#from PVBM.helpers.far import far
from models.PVBM.GraphRegularisation.GraphRegularisation import TreeReg
from models.PVBM.GraphCRE.GraphCentralRetinalEquivalent import Tree
class CREVBMs:
    ...
    def compute_central_retinal_equivalents(self,blood_vessel, skeleton, xc,yc, radius, artery = True, Toplot = False):
        ...
        if len(plotable_list) != 0:
            ...
            if artery:
                ...
                return ({"crvek": crvek, "crveh": crveh}, plotable_list)
        else:
            if artery:
                return ({"craek": -1, "craeh": -1}, None)
            else:
                return ({"crvek": -1, "crveh": -1}, None)
